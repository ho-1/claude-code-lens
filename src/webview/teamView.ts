...
import { renderTaskBoard, getTaskViewScripts } from './taskView'

/**
 * Render the teams tab content
 */
export function renderTeamView(result: ScanResult, workspacePaths?: string[]): string {
  ...
  <div class="team-view">
    ...
    ${renderTaskBoard(result, workspacePaths)}
  </div>`
}
